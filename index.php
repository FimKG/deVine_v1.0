        ...
        <div class="intro-container">
            <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="carousel-item" style="background-image: url(assets/imgs/intro-carousel/2.jpg)">
                        <div class="carousel-container">
                            <div class="container">
                                <h2 class="animate__animated animate__fadeInDown">New and Used Cars</h2>
                    ...
                    <div class="carousel-item" style="background-image: url(assets/imgs/intro-carousel/5.jpg)">
                        <div class="carousel-container">
                            <div class="container">
                                <h2 class="animate__animated animate__fadeInDown">New and Used Cars</h2>
                                <p class="animate__animated animate__fadeInUp">Explore the vast model range of new and
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="text">
                        ...
                        viverra sed, nulla. Donec porta diam eu massa. Quisque diam
                        lorem, interdum vitae, dapibus ac, scelerisque vitae, pede.
                    </div>
                </div>
                <div class="col-lg-4">
                    <h2 class="pre-header">Services</h2>
                    <div class="text">
                        <div class="service-text mt-30">
                            <h6>D<span>iagnostics</span></h6>
                            <h6>M<span>echanical</span></h6>
                            <h6>P<span>enalbeating</span></h6>
                            <h6>U<span>pholstery</span></h6>
                            <h6>S<span>pry Painting</span></h6>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                    <h2 class="pre-header">Contact Us</h2>
                    <div class="text">
                        Let’s start talking about your projects or idea and find
                        out how we can help your auto care
                        <div class="pb-3"></div>
                        <div class="address mt-30">
                            <h6><i class="icofont-smart-phone icofont-2x"></i>
                                &nbsp;C<span>ell</span>:
